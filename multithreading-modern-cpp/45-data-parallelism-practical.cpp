...
int main() {
  ...
  // Do the calculations with std::async
	std::cout << "Sum of first 16 integers: " << add_parallel(vec) << '\n';
	std::cout << "Sum of 10,000 random numbers: " << add_parallel(vrand) << '\n';

  // Do the calculations with std::packaged_task
	std::cout << "Sum of first 16 integers: " << add_parallel_pt(vec) << '\n';
	std::cout << "Sum of 10,000 random numbers: " << add_parallel_pt(vrand) << '\n';

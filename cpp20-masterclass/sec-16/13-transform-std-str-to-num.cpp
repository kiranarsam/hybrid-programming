...
int main() {
    ...
    int int_var1 = std::stoi(number_str);
    std::cout << "int_var1 : " << int_var1 << std::endl;
    std::cout << "sizeof(int_var1) : " << sizeof(int_var1) << std::endl;
    ...
    float float_var3 = std::stof(number_str3);
    std::cout << "float_var3 : " << float_var3 << std::endl;
    std::cout << "sizeof(float_var3) : " << sizeof(float_var3) << std::endl;

    double double_var3 = std::stod(number_str3);
    std::cout << "double_var3 : " << double_var3 << std::endl;
    std::cout << "sizeof(double_var3) : " << sizeof(double_var3) << std::endl;

    long double long_double_var3 = std::stold(number_str3);
    std::cout << "long_double_var3 : " << long_double_var3 << std::endl;
    std::cout << "sizeof(long_double_var3) : " << sizeof(long_double_var3) << std::endl;

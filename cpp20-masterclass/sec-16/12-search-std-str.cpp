...
int main() {
    ...
    found_pos = string2.find(search_for2);
    ...
    found_pos = string3.find(search_for3);
    std::cout << "ter found at position : " << found_pos << std::endl;

    found_pos = string3.find(search_for3, 0);
    std::cout << "ter found at position : " << found_pos << std::endl;

    found_pos = string3.find(search_for3, 10);
    std::cout << "ter found at position : " << found_pos << std::endl;
    ...
    found_pos = string4.find(c_string2, 2);
    if (found_pos != std::string::npos) {
